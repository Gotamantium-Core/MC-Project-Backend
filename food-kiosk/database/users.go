...
func CreateUser(ctx context.Context, db *sql.DB, rollNo string, name string, phone string) (int64, error) {
...
func GetUserByRollNo(ctx context.Context, db *sql.DB, rollNo string) (*User, error) {
	var user User
